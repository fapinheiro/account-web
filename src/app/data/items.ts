...
export const items: Item[] = [
	{ date: new Date(2021, 10, 15), category: categories[0], title: 'McDonalds', value: 32.12},
	...
	{ date: new Date(2021, 10, 13), category: categories[2], title: 'Salário ACME', value: 4000}
] 